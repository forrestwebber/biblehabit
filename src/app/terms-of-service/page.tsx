  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      <div className="container mx-auto px-4 py-24">
        ...
        <p className="mt-4 text-gray-400">Last updated: September 4, 2026</p>
        <div className="mt-8 space-y-4 text-gray-300">
          ...
          <h2 className="text-2xl font-semibold">1. Free Account and BibleHabit Plus</h2>
          <p>A BibleHabit account is <strong>free</strong>, with no card required. The free account includes custom reading plans, today&apos;s reading, daily progress and streak tracking, the KJV and WEB translations, and your notes and highlights. The Scripture we serve directly is public domain and we do not put it behind a paywall.</p>
          <p><strong>BibleHabit Plus</strong> is an optional subscription that adds the pacing features: projected finish dates, personalized reflow suggestions when you fall behind, and the other Plus features listed on the pricing page at the time you subscribe.</p>
          <p>Plus costs <strong>$2.99 per month</strong> or <strong>$19.99 per year</strong> (introductory price; regular price $24.99 per year), in U.S. dollars. On the web, Plus is billed through Stripe and can be cancelled at any time from the billing portal linked on your Profile page. In the iOS app, Plus is sold through Apple In-App Purchase under Apple&apos;s terms; any introductory offer is shown at the point of purchase, and you manage or cancel it in your App Store subscription settings. Subscriptions renew automatically at the end of each billing period until cancelled. Cancelling stops future charges; access continues through the period you have already paid for. Prices may change with notice before a renewal.</p>
          <p>Your reading history, notes and highlights belong to you and remain in your account whether or not you subscribe. A subscription is tied to your BibleHabit account and applies wherever you sign in.</p>
