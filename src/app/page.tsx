  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800">
      ...
      <section id="verse" className="text-center py-20 px-6 max-w-3xl mx-auto">
        ...
        <p className="text-lg text-stone-500 mb-8">— {todaysVerse.reference} ({todaysVerse.translation})</p>
        <div className="flex items-center justify-center gap-4">
          <button className="flex items-center gap-2 bg-amber-600 text-white px-6 py-3 rounded-lg hover:bg-amber-700 transition font-semibold">
            <BookOpen className="h-5 w-5" /> Start Reading
          </button>
          <button className="flex items-center gap-2 border border-stone-300 text-stone-600 px-6 py-3 rounded-lg hover:bg-stone-100 transition">
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          {[
            { icon: <BookOpen className="h-8 w-8 text-amber-600" />, title: "Daily Verse", desc: "A fresh verse every day to center your morning. Public domain translations — no licensing, just Scripture." },
            { icon: <Clock className="h-8 w-8 text-amber-600" />, title: "Reading Plans", desc: "Bible in a Year, Psalms 30-Day, Gospels Deep Dive. Pick a plan, track your progress, build the habit." },
            { icon: <Heart className="h-8 w-8 text-amber-600" />, title: "Streaks & Progress", desc: "Track your daily reading streak. Missed a day? Catch up. See how far you have come." },
          ].map((f) => (
      ...
      <section className="py-16 px-6 bg-stone-100">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-stone-900 mb-4">Get Your Own Copy</h2>
          <p className="text-stone-500 mb-8">Hold Scripture in your hands. These are our recommended editions.</p>
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-stone-200 py-8 px-6 text-center text-stone-400 text-sm">
