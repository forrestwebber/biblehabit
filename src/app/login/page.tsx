      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-violet-100 p-8">
          ...
          <div className="space-y-3">
            ...
            <input 
              ...
              className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 text-slate-800" 
            />
            <input 
              type="password" 
            ...
            {message && (
              <p className={`text-sm text-center ${message.includes("Check your email") ? "text-green-600" : "text-red-500"}`}>
                {message}
              </p>
            )}
          </div>
        ...
        <p className="text-center text-sm text-slate-400 mt-6">
          {mode === "signup" ? (
            ...
            <>Need an account? <button onClick={() => setMode("signup")} className="text-violet-600 hover:text-violet-800 font-medium">Create one free</button></>
          )}
        </p>
      </div>
    </div>
