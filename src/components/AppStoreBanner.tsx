...
export default function AppStoreBanner() {
  ...
  return (
    <div className="w-full px-4 py-2.5 flex items-center justify-between gap-3 z-50" style={{ background: "#221C14", color: "#F4EEE1" }}>
      <div className="flex items-center gap-3 min-w-0">
        <div className="flex-shrink-0 w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: "#F4EEE1" }}>
          <svg className="w-5 h-5" style={{ color: "#221C14" }} fill="currentColor" viewBox="0 0 24 24">
